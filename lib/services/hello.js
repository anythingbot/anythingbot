      ...
      wss.on('connection', function (ws) {
        ...
        ws.on('message', function(data, flags) {
          ...
          if (data.content == "warning") {
              ...
              media.onFBI();
          } else if (data.content == "nsa") {
              media.onNSA();
          } else if (data.content == "cia") {
              media.onCIA();
          } else if (data.content == "usa") {
              media.onUSA();
          } else if (data.content == "tv") {
              media.onTV();
          } else if (data.content == "vague") {
              media.onVague();
          } else if (data.content == "talk") {
              media.onTalk();
          } else if (data.content == "berlin") {
              media.onBerlin();
          } else if (data.content == "code") {
              media.onCode();
              ...
              media.onPower();
          } else if (data.content == "train") {
              media.onTrain();
          } else if (data.content == "anthem") {
              media.onAnthem();
          } else if (data.content == "world") {
              media.onWorld();
