(function() {
    ...
    define(deps, function(
      ...
      var refreshAllComments = function refreshAllComments(pr, cb) {
        ...
        gh.getAllPages(prRequest, gh.issues.getComments,
      ...
      var postVoteStarted = function postVoteStarted(pr) {
        ...
        this.getVoteStartedComment(pr, function (err, comment) {
          ...
          makeComment(pr.number, self.templates.voteStartedComment + " " + pr.head.sha, function (err) {
            if (err) {
      ...
      var processPR = function processPR(pr, cb) {
        ...
        makeComment(pr.number, this.templates.voteEndComment(passes, voteResults.positive, voteResults.negative, voteResults.nonStarGazers));
