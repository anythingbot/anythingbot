(function () {
  ...
  define(deps, function (power_cycle) {
    ...
    var PLs = {
      ...
      'cult' : [
        [ 'youtube', 'cult', 'https://www.youtube.com/watch?v=DWMi6-G82Dk', 0,4,21 ]
      ],
      'mkultra' : [
      ...
      'GRAND TOURER' : [
         ...
         [ 'youtube', 'Star Trek: The Next Generation All Good Things Final Scene (BLUERAY HD)',
           'https://www.youtube.com/watch?v=mt3MVP3FizQ', 0,3,50 ],
      ...
      'love' : [
        [ 'youtube', 'ART OF NOISE: MOMENTS IN LOVE (THE ORIGINAL)',
          'https://www.youtube.com/watch?v=ux3u31SAeEM', 0,10,30 ]
      ],
      'love2' : [
      ...
      'ghostrunner' : [
        ...
        [ 'youtube', '不協和音 Dissonance by iacon | Full Album | Vaporwave',
          'https://www.youtube.com/watch?v=AkvV43AlvXk', 1,20,10],
        [ 'youtube', '不協和音 Dissonance by iacon | Full Album | Vaporwave',
          'https://www.youtube.com/watch?v=AkvV43AlvXk', 1,20,10],
        [ 'youtube', '不協和音 Dissonance by iacon | Full Album | Vaporwave',
          'https://www.youtube.com/watch?v=AkvV43AlvXk', 1,20,10],
      ...
      'weekend' : [
        ...
        [ 'youtube', 'Triumph des Willens (1935) - Triumph of the Will', 'https://www.youtube.com/watch?v=GHs2coAzLJ8', 1,44,27, ],
