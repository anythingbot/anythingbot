(function () {
  ...
  var weekdayPL = [
    ...
    [
        'youtube',
        'Darshan Ambient - A Walk Along The Ganges',
        'https://www.youtube.com/watch?v=MiKzf04zsMY',
        0,7,47,
    ],
    [
        'youtube',
    ...
    [
        'youtube',
        'Aaron Copland - Appalachian Spring, Rodeo, Billy the Kid, Fanfare for the Common Man',
        'https://www.youtube.com/watch?v=SNZs82BZ9R8',
        1,7,27,
    ],
    [
        'soundcloud',
        'Steve Mill - Abandoned Fields (Neil Quigley Pacemaker Remix)',
    ...
    [
        'soundcloud',
        'Modernism',
        'https://soundcloud.com/fozyofficial/modernism',
        '216437094',
        0,4,40,
    ],
    [
    ...
    [
        'youtube',
        '090407 The Five Hindrances \\ \\ Thanissaro Bhikkhu \\ \\ Dhamma Talks',
        'https://www.youtube.com/watch?v=UfprOkjdukw',
        0,16,47,
    ],
    [
        'youtube',
        'Ajahn Amaro - 19.11.14 - Seven Factors of Enlightenment - The Five Hindrances',
        'https://www.youtube.com/watch?v=gLKNlYMJw-Q',
        1,57,0,
    ],
    [
        'youtube',
    ...
    [
        'youtube',
        'Mystical Sun - Journey To Samadhi',
        'https://www.youtube.com/watch?v=rEnF1IsI7Nk',
        0,32,26,
    ],
    [
        'youtube',
  ...
  var tvPL = [
    [
      ...
      'https://www.youtube.com/watch?v=MBWIlv6jKiE',
      0,10,15
    ]
  ];
  ...
  var vaguePL = [
    [
      ...
      'https://www.youtube.com/watch?v=vK75KSr61eE',
      0,35,49
    ],
    [
      'youtube',
      'Oneohtrix Point Never – Memory Vague Full DVD',
  ...
  var fbiPL = [
    ...
    [
      'youtube',
      'Show Champion EP.221 LIPBUBBLE - POPCORN',
      'https://www.youtube.com/watch?v=wfVfJrBpXgs',
      0,3,17
    ]
  ];
  ...
  var ciaPL = [
    [
      'youtube',
      'Traffic (4/10) Movie CLIP - Conspiring to Conspire (2000) HD',
  ...
  var codePL = [
    ...
    [
      'youtube',
      'Communism In Poland',
      'https://www.youtube.com/watch?v=soSz64AI-NI',
      0,30,3,
    ]
  ];
  ...
  var powerPL = [
    [
      'youtube',
      'Sasha Live from Energy @ Eclipse Coventry 1991',
      'https://www.youtube.com/watch?v=WkggrVyPGBc',
      1,21,20,
    ]
  ];
  ...
  var talkPLs = [
     [
       [
         'youtube',
         'Ajahn Chah - Convention And Liberation',
         'https://www.youtube.com/watch?v=gxVGofXtaD8',
         0,17,20
       ],
       [
         'youtube',
         'Ajahn Chah - Living In This World',
         'https://www.youtube.com/watch?v=kOK6W-vOLec',
         0,19,19
       ]
     ],
     [
  ...
  var trainPL = [
    ...
    [
      ...
      'https://www.youtube.com/watch?v=SvmgpyVcYJc',
      0,12,16
    ]
  ];
  ...
  var weekendPL = [
    ...
    [
        'youtube',
        'Mark Isham / Tibet -Part Ⅰ',
        'https://www.youtube.com/watch?v=C7ZgTO6jlx0',
        0,13,13,
    ],
    [
        'youtube',
        'Mark Isham / Tibet -Part Ⅱ',
        'https://www.youtube.com/watch?v=ABp6M17NHqU',
        0,4,52,
    ],
    [
        'youtube',
        'Mark Isham / Tibet - Part Ⅲ',
        'https://www.youtube.com/watch?v=qw1oJiKQ3qI',
        0,6,23,
    ],
    [
        'youtube',
        'Mark Isham / Tibet - Part Ⅳ',
        'https://www.youtube.com/watch?v=U53g8Fgcdt4',
        0,9,6,
    ],
    [
        'youtube',
        'Mark Isham / Tibet - Part Ⅴ',
        'https://www.youtube.com/watch?v=drdIaFKgveg',
        0,14,36,
    ],
    [
        'youtube',
  ...
  var knowPL = [
    [
        ...
        'https://www.youtube.com/watch?v=IPV0RC9CDis',
        1,25,21,
    ],
    [
        'youtube',
        'INTERNET CLUB - REDEFINING THE WORKPLACE',
        'https://www.youtube.com/watch?v=jNZQLePeMs4',
        1,15,22,
    ],
  ];
  ...
  var thursdayPL = [
    ...
    [
      'youtube',
      'Epena Ceremony',
      'https://www.youtube.com/watch?v=ybloBijCSd0',
      0,4,13,
    ],
    [
      'youtube',
      'Elve - Plant Cell Perceptions',
      'https://www.youtube.com/watch?v=C3-Y9NrGUP0',
      0,9,1,
    ],
    [
      'soundcloud',
    ...
    [
      'youtube',
      'Elve - Vale (Infinite Garden)',
      'https://www.youtube.com/watch?v=yyR1jdLaPGA',
      0,13,23,
    ],
    [
      'youtube',
      'Abyss (ambient techno)',
      'https://www.youtube.com/watch?v=iYw3uV8cD8Q',
      0,8,0,
    ],
    [
      'youtube',
    ...
    [
      'soundcloud',
      'Intro ("The Hyper-Plunder Blunder")',
      'https://soundcloud.com/erohypnos/intro-the-hyper-plunder-blunder',
      '291037078',
      0,0,36,
    ],
    [
      'soundcloud',
      'Nike Slogan On Repeat. Meatknife For The Jugular.',
      'https://soundcloud.com/erohypnos/nike-slogan-on-repeat-meatknife-for-the-jugular',
      '291037265',
      0,3,26,
    ],
    [
      'soundcloud',
      'Future Funk and A E S T H E T I C S Made Me A Dangerous Drunk',
    ...
    [
      'soundcloud',
      'chese pizza, 8-12slices ,no sasauge [Anonymous 01/11/16(Tue)19:49 No. 3758]',
      'https://soundcloud.com/erohypnos/pizza-8-12slices-no-sasauge-anonymous-011116tue1949-no-3758',
      '291037985',
      0,2,42,
    ],
    [
      'soundcloud',
      'hardclam(1-4).xrns, from the \'Fuck the Hanzi//Soft-AntiCorp//Unicode Shit\' Sessions',
      'https://soundcloud.com/erohypnos/hardclam1-4xrns',
      '291038275',
      0,2,39,
    ],
    [
      'soundcloud',
      'hardclam5.xrns, from the \'Fuck the Hanzi//Soft-AntiCorp//Unicode Shit\' Sessions',
      'https://soundcloud.com/erohypnos/hardclam5xrns',
      '291038495',
      0,3,37,
    ],
    [
      'soundcloud',
      'K:\\music\\trx\\(K:\\music\\trx\\(K:\\music\\trx\\(K:\\...\\\\\\\\)))',
      'https://soundcloud.com/erohypnos/kmusictrxkmusictrxkmusictrxk',
      '323209653',
      0,2,8,
    ],
    [
      'soundcloud',
      'Outro ("The Meta-Plunder Blunder" feat. Track 2 [meatknife.xrns])',
      'https://soundcloud.com/erohypnos/outro-the-meta-plunder-blunder-feat-track-2-meatknifexrns',
      '291038596',
      0,0,29,
    ],
  ];
  ...
  var fridayPL = [
    ...
    [
      'youtube',
      'Sasha The Eclipse New Years Eve 1990',
      'https://www.youtube.com/watch?v=uij11TMnSEE',
      1,6,37,
    ],
    [
      'youtube',
  ...
  var prismPL = [
    [
        'youtube',
        'PrismCorp Virtual Enterprises - ClearSkies™ (Full Cassette Rip)',
        'https://www.youtube.com/watch?v=ieuGJL8Ayvk',
        1,2,2,
    ],
  ];
  ...
  var makePlaylists = function(plSources) {
      var results = [];
      var i;
      for (i = 0; i < plSources.length; i += 1) {
          results.push(makePlaylist(plSources[i]));
      }
      return results;
  }
  ...
  var onContact = function () {
    media.special = [media.getSPM(new Date()),media.contactPlaylist];
  };

  var onFBI = function () {
    media.special = [media.getSPM(new Date()),media.fbiPlaylist];
  };

  var onNSA = function () {
    media.special = [media.getSPM(new Date()),media.nsaPlaylist];
  };

  var onCIA = function () {
    media.special = [media.getSPM(new Date()),media.ciaPlaylist];
  };

  var onUSA = function () {
    media.special = [media.getSPM(new Date()),media.usaPlaylist];
  };

  var onTV = function () {
    media.special = [media.getSPM(new Date()),media.tvPlaylist];
  };

  var onVague = function () {
    media.special = [media.getSPM(new Date()),media.vaguePlaylist];
  };
  
  var onTalk = function () {
    media.special = [media.getSPM(new Date()),media.talkPlaylists[media.talkCounter]];
    media.talkCounter = (media.talkCounter + 1) % media.talkPlaylists.length;
  };
  ...
  var onPrism = function () {
    media.special = [media.getSPM(new Date()),media.prismPlaylist];
  };
  ...
  var onBerlin = function () {
    media.special = [media.getSPM(new Date()),media.berlinPlaylist];
  };

  var onCode = function () {
    media.special = [media.getSPM(new Date()),media.codePlaylist];
  };
  ...
  var onPower = function () {
    media.special = [media.getSPM(new Date()),media.powerPlaylist];
  };

  var onKnow = function () {
    media.special = [media.getSPM(new Date()),media.knowPlaylist];
  };

  var onTrain = function () {
    media.special = [media.getSPM(new Date()),media.trainPlaylist];
  };

  var onAnthem = function () {
    media.special = [media.getSPM(new Date()),media.anthemPlaylist];
  };

  var onWorld = function () {
    media.special = [media.getSPM(new Date()),media.worldPlaylist];
  };
  ...
  media = {
    ...
    talkCounter : 0,
    talkPlaylists : makePlaylists(talkPLs),
    berlinPlaylist : makePlaylist(berlinPL),
    codePlaylist : makePlaylist(codePL),
    girlsPlaylist : makePlaylist(girlsPL),
    yzmaPlaylist : makePlaylist(yzmaPL),
    contactPlaylist : makePlaylist(contactPL),
    fbiPlaylist : makePlaylist(fbiPL),
    nsaPlaylist : makePlaylist(nsaPL),
    ciaPlaylist : makePlaylist(ciaPL),
    usaPlaylist : makePlaylist(usaPL),
    tvPlaylist : makePlaylist(tvPL),
    vaguePlaylist : makePlaylist(vaguePL),
    cometPlaylist : makePlaylist(cometPL),
    prismPlaylist : makePlaylist(prismPL),
    ...
    powerPlaylist : makePlaylist(powerPL),
    trainPlaylist : makePlaylist(trainPL),
    anthemPlaylist : makePlaylist(anthemPL),
    worldPlaylist : makePlaylist(worldPL),
    thursdayPlaylist : makePlaylist(thursdayPL),
    wednesdayPlaylist : makePlaylist(wednesdayPL),
    knowPlaylist : makePlaylist(knowPL),
