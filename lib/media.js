(function () {
  ...
  define(deps, function (power_cycle) {
    ...
    var PLs = {
      ...
      'bladerunner' : [
        [ 'personality', 4,51,0 ],
        [ 'youtube', 'Vangelis - Blade Runner 2002 Esper Edition', 'https://www.youtube.com/watch?v=FwhZ11lcOJQ', 1,52,46],
        [ 'personality', 24,0,0 ],
      ],
    ...
    var getMediaForUTC = function (utc) {
      ...
      // blade runner
      if (spmUTC >= 4 * 3600 + 51 * 60 && spmUTC < 6 * 3600 + 45 * 60) {
          cartridge = media.bladerunnerCartridge;
      }
