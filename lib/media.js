(function () {
  ...
  var PLs = {
    ...
    'weekend' : [
      ...
      [ 'youtube', 'Blade Runner Soundtrack [Full Vinyl Rip 2013]', 'https://www.youtube.com/watch?v=2x3UNHNo1LA', 0,59,48, ],
  ...
  media = {
    ...
    weekdayPlaylist : makePlaylist(PLs.weekday),
    weekendPlaylist : makePlaylist(PLs.weekend),
    warningPlaylist : makePlaylist(PLs.warning),
    jewPlaylist : makePlaylist(PLs.jew),
    talkCounter : 0,
    talkPlaylists : makePlaylists(talkPLs),
    berlinPlaylist : makePlaylist(PLs.berlin),
    codePlaylist : makePlaylist(PLs.code),
    girlsPlaylist : makePlaylist(PLs.girls),
    yzmaPlaylist : makePlaylist(PLs.yzma),
    contactPlaylist : makePlaylist(PLs.contact),
    fbiPlaylist : makePlaylist(PLs.fbi),
    nsaPlaylist : makePlaylist(PLs.nsa),
    ciaPlaylist : makePlaylist(PLs.cia),
    usaPlaylist : makePlaylist(PLs.usa),
    tvPlaylist : makePlaylist(PLs.tv),
    vaguePlaylist : makePlaylist(PLs.vague),
    cometPlaylist : makePlaylist(PLs.comet),
    prismPlaylist : makePlaylist(PLs.prism),
    borgPlaylist : makePlaylist(PLs.borg),
    losePlaylist : makePlaylist(PLs.lose),
    marsPlaylist : makePlaylist(PLs.mars),
    mkultraPlaylist : makePlaylist(PLs.mkultra),
    powerPlaylist : makePlaylist(PLs.power),
    trainPlaylist : makePlaylist(PLs.train),
    anthemPlaylist : makePlaylist(PLs.anthem),
    worldPlaylist : makePlaylist(PLs.world),
    thursdayPlaylist : makePlaylist(PLs.thursday),
    wednesdayPlaylist : makePlaylist(PLs.wednesday),
    knowPlaylist : makePlaylist(PLs.know),
    fridayPlaylist : makePlaylist(PLs.friday),
    special : [null,null],
    block : null,
    onWarning : onWarning,
    onGirls : onGirls,
