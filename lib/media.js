(function () {
  ...
  var getMediaForUTC = function (utc) {
    ...
    if (dayOfWeek == 0 || dayOfWeek == 6) {
        libEntry = media.weekendCartridge;
    } else if (dayOfWeek == 3) {
        libEntry = media.wednesdayCartridge;
    } else if (dayOfWeek == 4) {
        libEntry = media.thursdayCartridge;
    } else if (dayOfWeek == 5) {
        libEntry = media.fridayCartridge;
    } else {
        libEntry = media.weekdayCartridge;
    }
    // Add jew
    if (utc.getMonth() == 2 && utc.getDate() >= 9 && utc.getDate() <= 11) {
        libEntry = media.jewCartridge;
    }
  ...
  var onSkip = function(nMinutes) {
    if (media.special[0] > 60 * nMinutes) {
