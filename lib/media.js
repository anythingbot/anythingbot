(function () {
  ...
  define(deps, function (power_cycle) {
    ...
    var PLs = {
      ...
      '2002' : [
        [ 'soundcloud', 'Vinylgroover September 2002 Mix',
          'https://soundcloud.com/chaosbot-group/september-2002-mix', '328332652', 0,58,49 ],
      ],
      '2004' : [
      ...
      'love' : [
        [ 'youtube', 'Red Hot Chili Peppers - Love Rollercoaster (High Quality)',
          'https://www.youtube.com/watch?v=N1cbsLKXasQ', 0,3,39 ]
      ],
      'death' : [
      ...
      'nine11' : [
        [ 'personality', 6,0,0 ],
        [ 'youtube', '猫 シ Corp. : NEWS AT 11', 'https://www.youtube.com/watch?v=qSh2HswKn5Y', 1,11,9],
      ],
      'jew' : [
      ...
      'weekend' : [
        ...
        [ 'youtube', 'Mark Isham / Sympathy and Acknowledgement', 'https://www.youtube.com/watch?v=ZZy3aB-jFiY', 0,8,22, ],
        ...
        [ 'youtube', 'Star Trek Continues E03 "Fairest of Them All"',
          'https://www.youtube.com/watch?v=dJf2ovQtI6w', 0,40,26, ],
      ...
      'doom' : [
        [ 'youtube', 'DOOM SONG', 'https://www.youtube.com/watch?v=s2jvANh2aEc', 0,0,41, ],
      ],
      'taco' : [
        [ 'youtube', 'GIR LOVES TACOS', 'https://www.youtube.com/watch?v=6fJh7j3INmw', 0,0,48, ],
      ],
      'mars' : [
      ...
      'cat' : [
        [ 'youtube', 'Alice In Wonderland- The Cheshire Cat', 'https://www.youtube.com/watch?v=G4fHre-yRPY', 0,3,4 ],
      ],
      'nuke' : [
    ...
    var makeCartridge = function (plSource) {
      ...
      for (i = 0; i < plSource.length; i += 1) {
        ...
        if (itemType === 'youtube') {
            ...
            itemTitle = playlistItem[1];
            itemURL = playlistItem[2];
            itemMid = playlistItem[2].slice(playlistItem[2].length-7);
            itemHours = playlistItem[3];
            itemMinutes = playlistItem[4];
            itemSeconds = playlistItem[5];
            ...
            itemURL = '';
            itemMid = '0';
            itemHours = playlistItem[1];
            itemMinutes = playlistItem[2];
            itemSeconds = playlistItem[3];
        } else {
    ...
    var getMediaForUTC = function (utc) {
      ...
      // chakra
      if (spmUTC >= 4 * 3600 + 44 * 60 && spmUTC < 6 * 3600) {
          cartridge = media.nightChakraCartridge;
      }
      // 9/11
      if (spmUTC >= 6 * 3600 && spmUTC <= 7 * 3600 + 11 * 60 + 9) {
          cartridge = media.nine11Cartridge;
      }
      ...
      if (mediaItem.type == "youtube") {
          ...
          data.mediaIsDailymotion = 0;
      } else if (mediaItem.type == "dailymotion") {
          data.mediaIsYoutube = 0;
          data.mediaIsSoundcloud = 0;
          data.mediaIsDailymotion = 1;
      } else if (mediaItem.type == "personality") {
          data.mediaIsYoutube = 0;
          data.mediaIsSoundcloud = 0;
          data.mediaIsDailymotion = 0;
      }
