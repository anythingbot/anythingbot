  ...
  define(deps, function (power_cycle) {
    ...
    var PLs = {
      ...
      'psychology' : [
        ...
        [ 'shift', 0,7,18, 'youtube', 'DJ Morgan Sentinel Hard House Classics',
          'https://www.youtube.com/watch?v=nxxCjL8hZBY', 1,4,50 ],
      ...
      'love' : [
        ...
        [ 'youtube', 'New Order - The Perfect Kiss (12" Extended)',
          'https://www.youtube.com/watch?v=CdHnD22IZ48', 0,8,4 ],
      ...
      'ghostrunner' : [
        [ 'personality', 4,51,0 ],
        [ 'youtube', 'Ghost in the Shell Original Soundtrack',
          'https://www.youtube.com/watch?v=GvaC6cIrntI', 0,50,13],
        [ 'youtube', 'Vangelis - Blade Runner 2002 Esper Edition',
          'https://www.youtube.com/watch?v=FwhZ11lcOJQ', 1,52,46],
        [ 'youtube', 'Vangelis - Blade Runner 2002 Esper Edition',
          'https://www.youtube.com/watch?v=FwhZ11lcOJQ', 1,52,46],
        [ 'youtube', 'Vangelis - Blade Runner 2002 Esper Edition',
          'https://www.youtube.com/watch?v=FwhZ11lcOJQ', 1,52,46],
      ...
      'wheel' : [
        [ 'youtube', 'reading wheel sharp weapons poetic 32kb',
          'https://www.youtube.com/watch?v=AC0RwGeBci0', 0,43,50 ]
      ],
      'taco' : [
    ...
    var makeSutta = function (suttalines) {
        var i;
        var result = "";
        for (i = 0; i < suttalines.length; i += 1) {
            result += '<p>' + suttalines[i] + '</p>';
        }
        return result;
    }
...
'Supparaka. Stopping only for one night everywhere (along',
...
'did hear.'];
    ...
    media = {
      stories : {
        bahiya : {
          title : 'Bahiya Sutta: About Bahiya',
          body : sutta
        }
      },
      restartState : 0,
