(function () {
  ...
  define(deps, function (power_cycle) {
    ...
    var PLs = {
      'sorcery' : [
        [ 'youtube', 'Sabu Martinez - Sorcery! (1958) [Full Album]',
          'https://www.youtube.com/watch?v=g8KZNe8B-9w', 0,43,26 ]
      ],
      'we build men' : [
        [ 'youtube', 'War with Gwynne Dyer, Part 2: Anybody\'s Son Will Do (1983)',
          'https://www.youtube.com/watch?v=P_G2u1RrLOk', 0,54,26 ]
      ],
      'NASA' : [
        [ 'youtube', 'Diner scene from Easy Rider (1969)',
          'https://www.youtube.com/watch?v=eqHddcMUF9w', 0,4,17 ]
      ],
      'which one is your favorite' : [
        [ 'youtube', 'Sasha & Digweed - Northern Exposure 2 (West Coast Edition)',
          'https://www.youtube.com/watch?v=UEUbJo3cvKE', 1,11,9 ]
      ],
      'evil' : [
        [ 'youtube', 'Mumm-ra Tries To Wield The Sword Of Omens',
          'https://www.youtube.com/watch?v=5ORA1Q08hJo', 0,3,9 ]
      ],
      'metaphysical terror' : [
        [ 'youtube', 'The Westminster Presbyterian Sanctuary Choir, "Messiah" from "The Hallelujah Chorus"', 'https://www.youtube.com/watch?v=QqEHN81UIGs', 0,3,56 ]
      ],
      'chakra' : [
        ['youtube', 'Chakra Activation & Healing Meditation',
         'https://www.youtube.com/watch?v=R_mjh0K4nEM', 1,10,6 ]
      ],
      'jazz3' : [
        ['audio', 'Detroit New York Junction Thad Jones',
         '/Detroit_New_York_Junction_Thad_Jones.mp3', 0,34,34 ]
      ],
      'techno' : [
        ['audio', 'James Zabiela - Live @ Space, Ibiza Closing Fiesta Oct 2016',
         '/James_Zabiela_-_Live_Space_Ibiza_Closing_Fiesta_Oct_2016.mp3', 0,29,22 ]
      ],
      'I wanna dip my balls in it' : [
        ['youtube', 'Louie "I wanna dip my balls in it!"',
         'https://www.youtube.com/watch?v=4PMuxgTB888', 0,0,40 ]

      ],
      'happy birthday' : [
        [ 'youtube', 'Titanic Full Soundtrack',
          'https://www.youtube.com/watch?v=KfyxJtpvl7g', 1,14,59 ]
      ],
      'today' : [
        [ 'youtube', 'Thanissaro Bhikkhu - Your Mind Is Lying To You',
          'https://www.youtube.com/watch?v=8SBBda0g5uI', 0,14,39 ],
        [ 'youtube', '190527 A Good Purpose in Life \\ \\ Thanissaro Bhikkhu \\ \\ Dhamma Talk',
          'https://www.youtube.com/watch?v=jCpttEJURts', 0,12,15 ]
      ],
      'today2' : [
        [ 'youtube', 'Ajahn Chah - Unshakeable Peace',
          'https://www.youtube.com/watch?v=AuntIeOrKho', 1,46,57 ],
        [ 'youtube', '\"Aspects of Freedom\" by Ajahn Nyanadhammo',
          'https://www.youtube.com/watch?v=22HMb_rV-sc', 1,8,57 ],
        [ 'youtube', 'Ajahn Sucitto - The flood stopper',
          'https://www.youtube.com/watch?v=E1R8y4Ah8-s', 0,54,12 ],
        [ 'youtube', 'Ajahn Chah - The Path To Peace',
          'https://www.youtube.com/watch?v=eSQpTvv81YQ', 0,52,1 ],
        ...
        [ 'youtube', 'Ajahn Chah - Opening The Dhamma Eye',
          'https://www.youtube.com/watch?v=aHPMeqW8a0c', 0,32,6 ]
      ],
      ...
      'how to get fbi to comit violent crimes against their kids' : [
        [ 'youtube', 'How GHB effects looks like on people!',
          'https://www.youtube.com/watch?v=FoNTIpKorkg', 0,1,48 ],
        [ 'youtube', 'UK man tried to kill wife with homemade electric chair',
          'https://www.youtube.com/watch?v=LVGAghubpeg', 0,0,26 ]
      ],
      'mind control sub marine' : [
        [ 'youtube', 'The Beatles - Yellow Submarine',
          'https://www.youtube.com/watch?v=m2uTFF_3MaA', 0,2,45 ]
      ],
      'sin': [
        [ 'youtube', 'Doctor And The Medics - Spirit In The Sky (HQ)',
          'https://www.youtube.com/watch?v=VrUoDdS8lBc', 0,3,22 ]
      ],
      'save' : [
        [ 'youtube', 'Human "the score"(Extended mix) classic tune',
          'https://www.youtube.com/watch?v=fcAikOvTNKc', 0,6,40 ]
      ],
      'castration' : [
        [ 'youtube', 'FROZEN | Let It Go Sing-along | Official Disney UK',
          'https://www.youtube.com/watch?v=L0MK7qz13bU', 0,1,2 ],
        [ 'youtube', 'Robert Miles - Children [Dream Version]',
          'https://www.youtube.com/watch?v=CC5ca6Hsb2Q', 0,7,32 ]
      ],
      'dissolve the fbi' : [
        [ 'youtube', '200V DC electrolytic capacitor connected direct to 220V AC outlet, blow up', 'https://www.youtube.com/watch?v=WpzvXlWtPsQ', 0,2,17 ],
        [ 'youtube', 'HOW TO KILL YOUR CHILDREN ! (Guts and Glory Funny Moments)', 'https://www.youtube.com/watch?v=1c9pBQuXQRU', 0,11,7 ]
      ],
      'anythingbot mathematics typesetter' : [
        [ 'youtube', 'Veruca Salt\'s Golden Ticket',
          'https://www.youtube.com/watch?v=b9mba2qb9do', 0,1,53 ]
      ],
      'organize a civilian calorie siege of new york city' : [
        [ 'youtube', 'Elvis Presley - Jailhouse Rock (Music Video)',
          'https://www.youtube.com/watch?v=gj0Rz-uP4Mk', 0,2,43 ],
        [ 'youtube', 'Lost Tribe - Gamemaster (Original)',
          'https://www.youtube.com/watch?v=bboe1FRs2nI', 0,8,1 ]
      ],
      ...
      'a loved child' : [
        [ 'image', 'a loved child', 'http://anythingbot.org:3000/152176747757.gif', 0,0,30 ]
      ],
      'Beautiful Again' : [
        [ 'vevo', 'Back In Black (Official Video)',
          'https://www.vevo.com/watch/acdc/back-in-black-(official-video)/USSM20500197', 0,4,15 ]
      ],
      ...
      '+' : [
        [ 'youtube', 'Tradition Betrayed: The False Prophets of Modernism',
          'https://www.youtube.com/watch?v=ZnsXKtE5PNI', 0,39,22 ]
      ],
      'category' : [
      ...
      'Get leverage over the electric power company.' : [
        [ 'youtube', 'EMMANUEL PAHUD | Claude Debussy, "Syrinx" for solo flute',
          'https://www.youtube.com/watch?v=YEyKM13yf_4', 0,4,5 ]
      ],
      'Ask about the hostage crisis program.' : [
        [ 'youtube', 'EMMANUEL PAHUD | Claude Debussy, "Syrinx" for solo flute',
          'https://www.youtube.com/watch?v=YEyKM13yf_4', 0,4,5 ]
      ],
      'Ask about the pure dynamic range kills.' : [
        [ 'youtube', 'EMMANUEL PAHUD | Claude Debussy, "Syrinx" for solo flute',
          'https://www.youtube.com/watch?v=YEyKM13yf_4', 0,4,5 ]
      ],
      'Ask about the jealousy matrix.' : [
        [ 'youtube', 'EMMANUEL PAHUD | Claude Debussy, "Syrinx" for solo flute',
          'https://www.youtube.com/watch?v=YEyKM13yf_4', 0,4,5 ]
      ],
      'by the way,' : [
        [ 'youtube', 'Sinéad O\'Connor - Nothing Compares 2U [Official Music Video]',
          'https://www.youtube.com/watch?v=0-EF60neguk', 0,5,8 ],
        [ 'youtube', 'Matt Darey | Ibiza Euphoria - CD1 (1999)',
          'https://www.youtube.com/watch?v=VVQiVYOG25U', 1,15,10 ],
        [ 'youtube', 'Sinéad O\'Connor - Nothing Compares 2U [Official Music Video]',
          'https://www.youtube.com/watch?v=0-EF60neguk', 0,5,8 ],
      ],
      'do the French want me dead' : [
        [ 'youtube', 'Vietnam War The Helicopter War Documentary',
          'https://www.youtube.com/watch?v=L8C2suKeRHY', 1,28,1 ]
      ],
      'what does West Point know about what NATO knows about the electric power grid' : [
        [ 'youtube', 'Vietnam War The Helicopter War Documentary',
          'https://www.youtube.com/watch?v=L8C2suKeRHY', 1,28,1 ]
      ],
      'was anyone trying to win the Vietnam War' : [
        [ 'youtube', 'Vietnam War The Helicopter War Documentary',
          'https://www.youtube.com/watch?v=L8C2suKeRHY', 1,28,1 ]
      ],
      'normalization war' : [
        [ 'youtube', '2001: A Space Odyssey - The lady who walks on the ceiling',
          'https://www.youtube.com/watch?v=0iiXUeil5fQ', 0,1,7 ]
      ],
      'do the French want me castrated' : [
        [ 'youtube', 'Vietnam War The Helicopter War Documentary',
          'https://www.youtube.com/watch?v=L8C2suKeRHY', 1,28,1 ]
      ],
      'the jews are bad' : [
        [ 'youtube', 'J.Strauss: On the Beautiful Blue Danube (2001: A Space Odyssey Soundtrack)',
          'https://www.youtube.com/watch?v=UwAzXBCCQrQ', 0,9,6 ],
        [ 'dailymotion', 'Michael Jackson - Bad',
          'http://www.dailymotion.com/video/x11wx1', 0,4,18 ],
      ],
      'sugar' : [
        [ 'dailymotion', 'A Spoonful of Sugar - Mary Poppins',
          'http://www.dailymotion.com/video/xrj22r', 0,5,14 ],
      ],
      'caused by rapid cascading failure in a power grid' : [
        [ 'youtube', 'Vietnam War The Helicopter War Documentary',
          'https://www.youtube.com/watch?v=L8C2suKeRHY', 1,28,1 ]
      ],
      'get the French to attack Vietnam' : [
        [ 'youtube', 'Vietnam War The Helicopter War Documentary',
          'https://www.youtube.com/watch?v=L8C2suKeRHY', 1,28,1 ]
      ],
      'win the Vietnam War' : [
      ...
      'you want my people dead' : [
        [ 'youtube', 'Vietnam War The Helicopter War Documentary',
          'https://www.youtube.com/watch?v=L8C2suKeRHY', 1,28,1 ]
      ],
      'you hunted me down, and now you want me dead' : [
        [ 'youtube', 'Vietnam War The Helicopter War Documentary',
          'https://www.youtube.com/watch?v=L8C2suKeRHY', 1,28,1 ]
      ],
      'Not Safe' : [
      ...
      'american military commanders = french terrorists' : [
        [ 'youtube', 'The Neverending Story (1984) [Soundtrack]',
          'https://www.youtube.com/watch?v=heHdOTt_iGc', 0,36,45 ]
      ],
      'HKE' : [
      ...
      'Paul Oakenfold' : [
        [ 'youtube', 'Paul Oakenfold - Creamfields (CD1)',
          'https://www.youtube.com/watch?v=FNPWywY18CM', 1,9,11 ]
      ],
      'BJS' : [
      ...
      'Pump Up The Hormone Control' : [
        [ 'youtube', 'Pump Up The Volume Original Theatrical Trailer (1990)',
          'https://www.youtube.com/watch?v=xLDehtTqyig', 0,2,41 ]
      ],
      'mkultra' : [
      ...
      'witchcraft' : [
        [ 'youtube', 'Paul Oakenfold - Global Underground: Live In Oslo (CD 2)',
          'https://www.youtube.com/watch?v=iUxURf_NToY', 1,6,12 ]
      ],
      'utopia' : [
      ...
      'Rave Party' : [
        [ 'youtube', 'Geoff Bastow - Tomorrow\'s Communications',
          'https://www.youtube.com/watch?v=PZJFgpgZFF0', 0,4,51 ],
        [ 'youtube', 'Mazzy Star - Fade Into You',
          'https://www.youtube.com/watch?v=ImKY6TZEyrI', 0,4,28 ],
        [ 'youtube', 'Stimulant DJs - Non Stop Energy',
          'https://www.youtube.com/watch?v=JBDF2n1ClH4', 0,7,27 ],
        [ 'youtube', 'Mars vs Mystre 1998 side B',
          'https://www.youtube.com/watch?v=Z7l4KihNoGI', 0,38,56 ],
        [ 'youtube', 'Mars vs Mystre Vol 2 Side A',
          'https://www.youtube.com/watch?v=yu5wHWceERE', 0,42,21 ],
        [ '"Walking On Air" by José Padilla',
          'https://www.youtube.com/watch?v=IfiQI0t-WeE', 0,6,14 ],
        [ 'Mystrë – The Mystery Machine',
          'https://www.youtube.com/watch?v=1Z2DEGvIwWE', 1,23,34 ]
      ],
      'leader' : [
        [ 'youtube', 'The Captain & Steve Thomas - The Leader',
          'https://www.youtube.com/watch?v=75apjZdnDo4', 0,7,39 ]
      ],
      'psychologist' : [
        [ 'youtube', 'The Guardian',
          'https://www.youtube.com/watch?v=egPR5MuE7u0', 0,3,50 ]
      ],
      'leroy' : [
      ...
      'GRAND TOURER' : [
         [ 'image', 'GRAND TOURER', 'http://anythingbot.org:3000/GT3.png',0,0,30 ],
      ...
      'jazz2' : [
        [ 'archive', 'Artie Shaw - Blues in the Night',
          'https://archive.org/embed/ArtieShaw_933', 1,6,39 ]
      ],
      'KRONOS' : [
        [ 'archive', 'Kronos ( 1957)',
      ...
      '1993' : [
        [ 'youtube', 'House music anthems synonymous with 1993',
          'https://www.youtube.com/watch?v=fjH6PJmzO9w', 1,32,11 ]
      ],
      '2006' : [
      ...
      'night' : [
        [ 'personality', 3,30,0 ],
        [ 'youtube', 'Armand (Antonio Banderas as)', 'https://www.youtube.com/watch?v=d9Zs4TeoGLE', 0,1,49 ],
        [ 'youtube', 'Armand (Antonio Banderas as)', 'https://www.youtube.com/watch?v=d9Zs4TeoGLE', 0,1,49 ],
        [ 'youtube', 'Armand (Antonio Banderas as)', 'https://www.youtube.com/watch?v=d9Zs4TeoGLE', 0,1,49 ],
        [ 'youtube', 'Armand (Antonio Banderas as)', 'https://www.youtube.com/watch?v=d9Zs4TeoGLE', 0,1,49 ],
        [ 'youtube', 'Armand (Antonio Banderas as)', 'https://www.youtube.com/watch?v=d9Zs4TeoGLE', 0,1,49 ],
      ...
      'constant' : [
        [ 'image', 'constant', '/constant.png', 0,2,0 ]
      ],
      'cia' : [
      ...
      'lovelove' : [
        [ 'youtube', 'Armand (Antonio Banderas as)',
          'https://www.youtube.com/watch?v=d9Zs4TeoGLE', 0,1,49 ]
      ],
      'holy' : [
      ...
      'ghostrunner' : [
        [ 'personality', 4,51,0 ],
        [ 'youtube', 'Vangelis - Blade Runner Soundtrack (Remastered 2017)',
          'https://www.youtube.com/watch?v=k3fz6CC45ok', 1,51,42 ],
        [ 'youtube', 'Vangelis - Blade Runner Soundtrack (Remastered 2017)',
          'https://www.youtube.com/watch?v=k3fz6CC45ok', 1,51,42 ],
        [ 'youtube', 'Vangelis - Blade Runner Soundtrack (Remastered 2017)',
          'https://www.youtube.com/watch?v=k3fz6CC45ok', 1,51,42 ],
      ...
      'trance' : [
        [ 'youtube', 'Dave Ralph | Tranceport II (CD2 - Arrivals) [1999]',
          'https://www.youtube.com/watch?v=_FslvQCnnzo', 1,6,31 ],
        [ 'youtube', 'Matt Darey | Ibiza Euphoria - CD2 (1999)',
          'https://www.youtube.com/watch?v=wtoWLoZpU_w', 1,16,3 ]
      ],
      '113' : [
      ...
      'sacred' : [
        [ 'youtube', 'Sacred Tapestry - Shader . Full Album [HD]',
          'https://www.youtube.com/watch?v=w3bxhofufFg', 0,56,19 ]
      ],
      'triangle' : [
        [ 'youtube', 'Pascal\'s Triangle and the Binomial Coefficients',
          'https://www.youtube.com/watch?v=OMr9ZF1jgNc', 0,5,40 ]
      ],
      'know' : [
      ...
      'bE' : [
        [ 'audio', 'bE', '/bE.wav', 0,4,32 ]
      ],
      'bF' : [
        [ 'audio', 'bF', '/bF.wav', 0,4,32 ]
      ],
      'track' : [
      ...
      'committment' : [
        [ 'audio', 'lol',
          'http://mp3.hardnrg.com/SuperfastOz-Psylence.mp3', 1,0,16 ],
      ],
      'Saudi Arabia' : [
        [ 'youtube', 'New Order - Touched By The Hand Of God [OFFICIAL MUSIC VIDEO]',
          'https://www.youtube.com/watch?v=T9M_bqIB6EU', 0,4,30 ],
      ...
      'god' : [
        ...
        [ 'youtube', '2001: A Space Odyssey "Star Gate" sequence',
          'https://www.youtube.com/watch?v=ou6JNQwPWE0', 0,9,38 ],
      ],
      'here' : [
      ...
      'exodus' : [
        [ 'dailymotion', 'Thundercats - S 1 E 1 - Exodus',
          'http://www.dailymotion.com/video/x6mogw6', 0,24,58 ]
      ],
      'girl' : [
    ...
    var makeCartridge = function (plSource) {
      ...
      for (i = 0; i < plSource.length; i += 1) {
        ...
        if (itemNetwork === 'title') {
            ...
            var newtime = timeAdd(itemHours,itemMinutes,itemSeconds,2);
            itemSeconds = newtime.s;
            itemMinutes = newtime.m;
            itemHours = newtime.h;
        } else if (itemNetwork === 'vevo') {
            itemTitle = plItem[1];
            itemURL = plItem[2];
            itemMid = plItem[2].slice(plItem[2].length-12);
            itemHours = plItem[3];
            itemMinutes = plItem[4];
            itemSeconds = plItem[5];
            // compensate for timing
            ...
            var newtime = timeAdd(itemHours,itemMinutes,itemSeconds,15);
            itemSeconds = newtime.s;
            itemMinutes = newtime.m;
            itemHours = newtime.h;
    ...
    var getDataForUTC = function (utc,datatype) {
      ...
      var isJewTime = (utc.getMonth() == 2 && utc.getDate() >= 9 && utc.getDate() <= 11);
      // Add jew
      if (isJewTime) {
      ...
      var isNightTime = (spmUTC >= 3 * 3600 + 30 * 60 && spmUTC <= 4 * 3600 + 51 * 60);
      // night
      if (isNightTime && ! isJewTime) {
          cartridge = media.nightCartridge;
      }
      var isBladeRunnerTime = (spmUTC >= 4 * 3600 + 51 * 60 && spmUTC < 11 * 3600);
      // blade runner
      if (isBladeRunnerTime && ! isJewTime) {
          cartridge = media.ghostrunnerCartridge;
      }
      var isMathTime = (spmUTC >= 16 * 3600 && spmUTC % 3600 < 10 * 60);
      // math
      if (isMathTime && ! isJewTime) {
      ...
      } else if (mediaItem.network == "vevo") {
          data.mediaIsVEVO = 1;
...
'did hear.']];
    ...
    var timeAdd = function(h,m,s,deltas) {
        var totals = Number(s) + 60 * Number(m) + 60 * 60 * Number(h);
        totals += deltas;
        return ({
            s : (totals % 60) | 0,
            m : (((totals - s) / 60) % 60) | 0,
            h : (((totals - s) / 60 - m) / 60) | 0
        });
    }
